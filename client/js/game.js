    ...
    var Game = Class.extend({
        init: function(app) {
            ...
            this.spriteNames = ["hand", "sword", "loot", "target", "talk", "sparks", "shadow16", "rat", "skeleton", "skeleton2", "spectre", "boss", "deathknight",
                                ...
                                "sorcerer", "octocat", "beachnpc", "bluearmor", "forestnpc", "desertnpc", "lavanpc", "clotharmor", "leatherarmor", "mailarmor",
                                "platearmor", "redarmor", "goldenarmor", "firefox", "death", "sword1", "axe", "chest",
                                "sword2", "redsword", "bluesword", "goldensword", "item-sword2", "item-axe", "item-redsword", "item-bluesword", "item-goldensword", "item-leatherarmor", "item-mailarmor",
                                "item-platearmor", "item-redarmor", "item-bluearmor", "item-goldenarmor", "item-flask", "item-cake", "item-burger", "morningstar", "item-morningstar", "item-firepotion"];
        },
        ...
        connect: function(action, started_callback) {
            ...
            this.client.onConnected(function() {
                ...
                // Set the gamecloud character name
                self.gamecloud.setCharacterName(self.player.name);
